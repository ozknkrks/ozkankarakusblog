  ...
  return (
    <div className="min-h-screen">
      <div className="bg-gray-100 dark:bg-gray-900 dark:border-b border-b-gray-800">
        <div className="flex flex-col items-center py-10  max-w-md xl:max-w-2xl mx-auto space-y-5">
          ...
          <button className="bg-emerald-500 px-4 py-2 rounded-sm font-bold text-white">
            Beni işe al
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 max-w-md md:max-w-xl lg:max-w-2xl xl:max-w-4xl mx-auto  gap-4">
